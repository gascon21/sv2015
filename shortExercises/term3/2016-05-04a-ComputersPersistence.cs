...
public class ComputersDatabase
{
    ...
    public static void Main()
    {
        ...
        char option;
        bool finished = false;
        if (File.Exists("computers.bd"))
        {
            try
            {
                IFormatter formatter = new BinaryFormatter();
                Stream stream = new FileStream("computers.bd",
        ...
        do
        {
            ...
            switch (option)
            {
                case '1':
                    ...
                    temp.memory.unit = Console.ReadLine();

                    Console.WriteLine("Enter the RAM size (e.g. 64)");
                    temp.memory.size = Convert.ToSingle(Console.ReadLine());

                    Console.WriteLine("Enter the comment");
                    temp.comment = Convert.ToString(Console.ReadLine());
                    computers.Add(temp);
                    break;
                ...
                case '6':
                    ...
                    else
                    {
                        ...
                        {
                            computer tempIn = new computer();
                            Console.WriteLine("Enter the brand:");
                            do
                            {
                                tempIn.brand = Console.ReadLine();
                            ...
                            Console.WriteLine("Enter the year");
                            tempIn.year = Convert.ToInt32(Console.ReadLine());
                            ...
                            Console.WriteLine("Enter the RAM unit (e.g. Kb)");
                            tempIn.memory.unit = Console.ReadLine();

                            Console.WriteLine("Enter the RAM size (e.g. 64)");
                            tempIn.memory.size = Convert.ToSingle(Console.ReadLine());

                            Console.WriteLine("Enter the comment");
                            tempIn.comment = Console.ReadLine();
                            computers.Insert(pos, tempIn);
                        }
                    }
                    Console.WriteLine();
                    break;
                ...
                case '8':
                    computer tempTrim = new computer();
                    for (int i = 0; i < computers.Count; i++)
                    {
                        tempTrim.comment = computers[i].comment.Trim();
                        computers[i] = tempTrim;
                    }
